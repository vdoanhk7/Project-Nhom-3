...
INSERT INTO items (id, seller_id, name, start_price, cur_highest, item_type, image) VALUES
(1, 2, 'Buc tranh Hoa Huong Duong', 5000000, 5000000, 'ART', NULL),
(2, 2, 'Laptop Gaming Asus ROG', 15000000, 16000000, 'ELECTRONICS', NULL),
(3, 3, 'Xe may Honda SH 150i', 40000000, 40000000, 'VEHICLE', NULL),
(4, 3, 'Dong ho thong minh Apple Watch', 3000000, 3500000, 'ELECTRONICS', NULL),
(5, 2, 'Bo suu tap vat pham dac biet', 2000000, 2000000, 'OTHER', NULL);
